...
// CRUD FL
$f = new Filiere(null, 'Ppn', 'INFO');
$idF = $filiereDao->insert($f);
out('Filiere insert id', $idF);
$foundF = $filiereDao->findById($idF);

out('Filiere findById', $foundF ? $foundF->getCode() 
        . ' / ' . $foundF->getLibelle() : 'null');
...
if (!$fInfo) { $tmp = new Filiere(null, 'mATH', 'MATHImatique'); $filiereDao->insert($tmp); $fInfo = $tmp; }
$e = new Etudiant(null, 'CNE99870', 'MOAAD', 'HETNAB', 'HETNAB.mOAAD@TEST.com', (int)$fInfo->getId());
